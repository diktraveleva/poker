...
$month = date('n');
$year = date('Y');	
$sql = "INSERT INTO news (title,details,permalink,source_id,category_id,thumbnail,datetime,hits,published,day,month,year) VALUES ('$title','$details','','0','$category_id','$thumbnail','$datetime','0','$published','$day','$month','$year')";
